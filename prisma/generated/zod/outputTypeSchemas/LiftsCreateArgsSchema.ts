...
export const LiftsCreateArgsSchema: z.ZodType<Prisma.LiftsCreateArgs> = z.object({
  select: LiftsSelectSchema.optional(),
  include: LiftsIncludeSchema.optional(),
  data: z.union([ LiftsCreateInputSchema,LiftsUncheckedCreateInputSchema ]),
}).strict() ;

export default LiftsCreateArgsSchema;
