...
export const SuperSetCreateArgsSchema: z.ZodType<Prisma.SuperSetCreateArgs> = z.object({
  select: SuperSetSelectSchema.optional(),
  include: SuperSetIncludeSchema.optional(),
  data: z.union([ SuperSetCreateInputSchema,SuperSetUncheckedCreateInputSchema ]).optional(),
}).strict() ;

export default SuperSetCreateArgsSchema;
