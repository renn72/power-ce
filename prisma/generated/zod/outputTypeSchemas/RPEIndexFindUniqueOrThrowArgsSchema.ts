...
export const RPEIndexFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.RPEIndexFindUniqueOrThrowArgs> = z.object({
  select: RPEIndexSelectSchema.optional(),
  where: RPEIndexWhereUniqueInputSchema,
}).strict() ;

export default RPEIndexFindUniqueOrThrowArgsSchema;
