...
export const CompPlanCreateArgsSchema: z.ZodType<Prisma.CompPlanCreateArgs> = z.object({
  select: CompPlanSelectSchema.optional(),
  include: CompPlanIncludeSchema.optional(),
  data: z.union([ CompPlanCreateInputSchema,CompPlanUncheckedCreateInputSchema ]),
}).strict() ;

export default CompPlanCreateArgsSchema;
