...
import { SuperSetCreateInputSchema } from '../inputTypeSchemas/SuperSetCreateInputSchema'
import { SuperSetUncheckedCreateInputSchema } from '../inputTypeSchemas/SuperSetUncheckedCreateInputSchema'
import { SuperSetUpdateInputSchema } from '../inputTypeSchemas/SuperSetUpdateInputSchema'
import { SuperSetUncheckedUpdateInputSchema } from '../inputTypeSchemas/SuperSetUncheckedUpdateInputSchema'
...
export const SuperSetUpsertArgsSchema: z.ZodType<Prisma.SuperSetUpsertArgs> = z.object({
  select: SuperSetSelectSchema.optional(),
  include: SuperSetIncludeSchema.optional(),
  where: SuperSetWhereUniqueInputSchema,
  create: z.union([ SuperSetCreateInputSchema,SuperSetUncheckedCreateInputSchema ]),
  update: z.union([ SuperSetUpdateInputSchema,SuperSetUncheckedUpdateInputSchema ]),
}).strict() ;

export default SuperSetUpsertArgsSchema;
