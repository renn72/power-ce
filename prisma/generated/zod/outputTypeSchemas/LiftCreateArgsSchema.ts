...
export const LiftCreateArgsSchema: z.ZodType<Prisma.LiftCreateArgs> = z.object({
  select: LiftSelectSchema.optional(),
  include: LiftIncludeSchema.optional(),
  data: z.union([ LiftCreateInputSchema,LiftUncheckedCreateInputSchema ]),
}).strict() ;

export default LiftCreateArgsSchema;
