...
import { CompLiftUpdateInputSchema } from '../inputTypeSchemas/CompLiftUpdateInputSchema'
import { CompLiftUncheckedUpdateInputSchema } from '../inputTypeSchemas/CompLiftUncheckedUpdateInputSchema'
...
export const CompLiftUpsertArgsSchema: z.ZodType<Prisma.CompLiftUpsertArgs> = z.object({
  select: CompLiftSelectSchema.optional(),
  where: CompLiftWhereUniqueInputSchema,
  create: z.union([ CompLiftCreateInputSchema,CompLiftUncheckedCreateInputSchema ]),
  update: z.union([ CompLiftUpdateInputSchema,CompLiftUncheckedUpdateInputSchema ]),
}).strict() ;

export default CompLiftUpsertArgsSchema;
