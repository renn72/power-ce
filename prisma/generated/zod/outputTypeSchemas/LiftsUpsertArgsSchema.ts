...
import { LiftsCreateInputSchema } from '../inputTypeSchemas/LiftsCreateInputSchema'
import { LiftsUncheckedCreateInputSchema } from '../inputTypeSchemas/LiftsUncheckedCreateInputSchema'
...
export const LiftsUpsertArgsSchema: z.ZodType<Prisma.LiftsUpsertArgs> = z.object({
  select: LiftsSelectSchema.optional(),
  include: LiftsIncludeSchema.optional(),
  where: LiftsWhereUniqueInputSchema,
  create: z.union([ LiftsCreateInputSchema,LiftsUncheckedCreateInputSchema ]),
  update: z.union([ LiftsUpdateInputSchema,LiftsUncheckedUpdateInputSchema ]),
}).strict() ;

export default LiftsUpsertArgsSchema;
