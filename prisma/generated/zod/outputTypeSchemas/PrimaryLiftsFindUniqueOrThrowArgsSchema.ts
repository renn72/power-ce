...
export const PrimaryLiftsFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.PrimaryLiftsFindUniqueOrThrowArgs> = z.object({
  select: PrimaryLiftsSelectSchema.optional(),
  where: PrimaryLiftsWhereUniqueInputSchema,
}).strict() ;

export default PrimaryLiftsFindUniqueOrThrowArgsSchema;
