...
export const WarmupTemplateCreateArgsSchema: z.ZodType<Prisma.WarmupTemplateCreateArgs> = z.object({
  select: WarmupTemplateSelectSchema.optional(),
  include: WarmupTemplateIncludeSchema.optional(),
  data: z.union([ WarmupTemplateCreateInputSchema,WarmupTemplateUncheckedCreateInputSchema ]),
}).strict() ;

export default WarmupTemplateCreateArgsSchema;
