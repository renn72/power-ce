...
export const SuperSetFindFirstOrThrowArgsSchema: z.ZodType<Prisma.SuperSetFindFirstOrThrowArgs> = z.object({
  ...
  distinct: z.union([ SuperSetScalarFieldEnumSchema,SuperSetScalarFieldEnumSchema.array() ]).optional(),
}).strict() ;

export default SuperSetFindFirstOrThrowArgsSchema;
