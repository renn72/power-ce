...
export const CompLiftFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.CompLiftFindUniqueOrThrowArgs> = z.object({
  select: CompLiftSelectSchema.optional(),
  where: CompLiftWhereUniqueInputSchema,
}).strict() ;

export default CompLiftFindUniqueOrThrowArgsSchema;
