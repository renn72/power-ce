...
export const OneRepMaxFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.OneRepMaxFindUniqueOrThrowArgs> = z.object({
  select: OneRepMaxSelectSchema.optional(),
  where: OneRepMaxWhereUniqueInputSchema,
}).strict() ;

export default OneRepMaxFindUniqueOrThrowArgsSchema;
