...
export const CompLiftAddressFindUniqueArgsSchema: z.ZodType<Prisma.CompLiftAddressFindUniqueArgs> = z.object({
  select: CompLiftAddressSelectSchema.optional(),
  where: CompLiftAddressWhereUniqueInputSchema,
}).strict() ;

export default CompLiftAddressFindUniqueArgsSchema;
