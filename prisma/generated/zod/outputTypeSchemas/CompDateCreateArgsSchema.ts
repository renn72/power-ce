...
export const CompDateCreateArgsSchema: z.ZodType<Prisma.CompDateCreateArgs> = z.object({
  select: CompDateSelectSchema.optional(),
  data: z.union([ CompDateCreateInputSchema,CompDateUncheckedCreateInputSchema ]),
}).strict() ;

export default CompDateCreateArgsSchema;
