...
export const WarmupTemplateUpdateArgsSchema: z.ZodType<Prisma.WarmupTemplateUpdateArgs> = z.object({
  select: WarmupTemplateSelectSchema.optional(),
  include: WarmupTemplateIncludeSchema.optional(),
  data: z.union([ WarmupTemplateUpdateInputSchema,WarmupTemplateUncheckedUpdateInputSchema ]),
  where: WarmupTemplateWhereUniqueInputSchema,
}).strict() ;

export default WarmupTemplateUpdateArgsSchema;
