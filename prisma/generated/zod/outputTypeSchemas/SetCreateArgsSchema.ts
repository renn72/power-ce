...
export const SetCreateArgsSchema: z.ZodType<Prisma.SetCreateArgs> = z.object({
  select: SetSelectSchema.optional(),
  include: SetIncludeSchema.optional(),
  data: z.union([ SetCreateInputSchema,SetUncheckedCreateInputSchema ]),
}).strict() ;

export default SetCreateArgsSchema;
