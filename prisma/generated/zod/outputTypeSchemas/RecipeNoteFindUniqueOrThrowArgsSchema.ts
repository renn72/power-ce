...
export const RecipeNoteFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.RecipeNoteFindUniqueOrThrowArgs> = z.object({
  select: RecipeNoteSelectSchema.optional(),
  include: RecipeNoteIncludeSchema.optional(),
  where: RecipeNoteWhereUniqueInputSchema,
}).strict() ;

export default RecipeNoteFindUniqueOrThrowArgsSchema;
