...
export const SuperSetUpdateArgsSchema: z.ZodType<Prisma.SuperSetUpdateArgs> = z.object({
  select: SuperSetSelectSchema.optional(),
  include: SuperSetIncludeSchema.optional(),
  data: z.union([ SuperSetUpdateInputSchema,SuperSetUncheckedUpdateInputSchema ]),
  where: SuperSetWhereUniqueInputSchema,
}).strict() ;

export default SuperSetUpdateArgsSchema;
