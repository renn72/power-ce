...
export const CompLiftAddressUpdateArgsSchema: z.ZodType<Prisma.CompLiftAddressUpdateArgs> = z.object({
  select: CompLiftAddressSelectSchema.optional(),
  data: z.union([ CompLiftAddressUpdateInputSchema,CompLiftAddressUncheckedUpdateInputSchema ]),
  where: CompLiftAddressWhereUniqueInputSchema,
}).strict() ;

export default CompLiftAddressUpdateArgsSchema;
