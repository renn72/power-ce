...
export const TrainerToClientUpdateArgsSchema: z.ZodType<Prisma.TrainerToClientUpdateArgs> = z.object({
  select: TrainerToClientSelectSchema.optional(),
  data: z.union([ TrainerToClientUpdateInputSchema,TrainerToClientUncheckedUpdateInputSchema ]),
  where: TrainerToClientWhereUniqueInputSchema,
}).strict() ;

export default TrainerToClientUpdateArgsSchema;
