...
export const SetUpdateArgsSchema: z.ZodType<Prisma.SetUpdateArgs> = z.object({
  select: SetSelectSchema.optional(),
  include: SetIncludeSchema.optional(),
  data: z.union([ SetUpdateInputSchema,SetUncheckedUpdateInputSchema ]),
  where: SetWhereUniqueInputSchema,
}).strict() ;

export default SetUpdateArgsSchema;
