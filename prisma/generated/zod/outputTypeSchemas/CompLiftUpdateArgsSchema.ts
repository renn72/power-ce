...
export const CompLiftUpdateArgsSchema: z.ZodType<Prisma.CompLiftUpdateArgs> = z.object({
  select: CompLiftSelectSchema.optional(),
  data: z.union([ CompLiftUpdateInputSchema,CompLiftUncheckedUpdateInputSchema ]),
  where: CompLiftWhereUniqueInputSchema,
}).strict() ;

export default CompLiftUpdateArgsSchema;
