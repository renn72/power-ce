...
export const BaseIngredientCreateArgsSchema: z.ZodType<Prisma.BaseIngredientCreateArgs> = z.object({
  select: BaseIngredientSelectSchema.optional(),
  include: BaseIngredientIncludeSchema.optional(),
  data: z.union([ BaseIngredientCreateInputSchema,BaseIngredientUncheckedCreateInputSchema ]),
}).strict() ;

export default BaseIngredientCreateArgsSchema;
