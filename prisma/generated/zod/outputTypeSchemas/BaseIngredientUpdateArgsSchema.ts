...
export const BaseIngredientUpdateArgsSchema: z.ZodType<Prisma.BaseIngredientUpdateArgs> = z.object({
  select: BaseIngredientSelectSchema.optional(),
  include: BaseIngredientIncludeSchema.optional(),
  data: z.union([ BaseIngredientUpdateInputSchema,BaseIngredientUncheckedUpdateInputSchema ]),
  where: BaseIngredientWhereUniqueInputSchema,
}).strict() ;

export default BaseIngredientUpdateArgsSchema;
