...
import { z } from 'zod';
import { WeekCreateNestedManyWithoutBlockInputSchema } from './WeekCreateNestedManyWithoutBlockInputSchema';

export const BlockCreateInputSchema: z.ZodType<Prisma.BlockCreateInput> = z.object({
  ...
  week: z.lazy(() => WeekCreateNestedManyWithoutBlockInputSchema).optional()
}).strict();
