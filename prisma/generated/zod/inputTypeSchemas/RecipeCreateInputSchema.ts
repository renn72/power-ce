...
import { IngredientCreateNestedManyWithoutRecipeInputSchema } from './IngredientCreateNestedManyWithoutRecipeInputSchema';
...
export const RecipeCreateInputSchema: z.ZodType<Prisma.RecipeCreateInput> = z.object({
  ...
  ingredients: z.lazy(() => IngredientCreateNestedManyWithoutRecipeInputSchema).optional(),
  notes: z.lazy(() => RecipeNoteCreateNestedManyWithoutRecipeInputSchema).optional()
}).strict();

export default RecipeCreateInputSchema;
