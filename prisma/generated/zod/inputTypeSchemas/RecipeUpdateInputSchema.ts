...
import { IngredientUpdateManyWithoutRecipeNestedInputSchema } from './IngredientUpdateManyWithoutRecipeNestedInputSchema';
import { RecipeNoteUpdateManyWithoutRecipeNestedInputSchema } from './RecipeNoteUpdateManyWithoutRecipeNestedInputSchema';
...
export const RecipeUpdateInputSchema: z.ZodType<Prisma.RecipeUpdateInput> = z.object({
  ...
  ingredients: z.lazy(() => IngredientUpdateManyWithoutRecipeNestedInputSchema).optional(),
  notes: z.lazy(() => RecipeNoteUpdateManyWithoutRecipeNestedInputSchema).optional()
}).strict();

export default RecipeUpdateInputSchema;
