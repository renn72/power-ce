...
export const IngredientUncheckedUpdateManyWithoutRecipeInputSchema: z.ZodType<Prisma.IngredientUncheckedUpdateManyWithoutRecipeInput> = z.object({
  id: z.union([ z.string().cuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  createdAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  baseIngredientId: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
...
export default IngredientUncheckedUpdateManyWithoutRecipeInputSchema;
