...
import { WeekUpdateOneWithoutDayNestedInputSchema } from './WeekUpdateOneWithoutDayNestedInputSchema';

export const DayUpdateWithoutExerciseInputSchema: z.ZodType<Prisma.DayUpdateWithoutExerciseInput> = z.object({
  ...
  week: z.lazy(() => WeekUpdateOneWithoutDayNestedInputSchema).optional()
}).strict();

export default DayUpdateWithoutExerciseInputSchema;
