...
import { ExerciseUpdateOneWithoutSsNestedInputSchema } from './ExerciseUpdateOneWithoutSsNestedInputSchema';

export const SuperSetUpdateInputSchema: z.ZodType<Prisma.SuperSetUpdateInput> = z.object({
  ...
  exercise: z.lazy(() => ExerciseUpdateOneWithoutSsNestedInputSchema).optional()
}).strict();

export default SuperSetUpdateInputSchema;
