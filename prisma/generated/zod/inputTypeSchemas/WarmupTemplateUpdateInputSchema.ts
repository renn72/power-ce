...
import { WarmupUpdateManyWithoutWarmupTemplateNestedInputSchema } from './WarmupUpdateManyWithoutWarmupTemplateNestedInputSchema';

export const WarmupTemplateUpdateInputSchema: z.ZodType<Prisma.WarmupTemplateUpdateInput> = z.object({
  ...
  warmups: z.lazy(() => WarmupUpdateManyWithoutWarmupTemplateNestedInputSchema).optional()
}).strict();

export default WarmupTemplateUpdateInputSchema;
