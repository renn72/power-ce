...
import { SetOrderByRelationAggregateInputSchema } from './SetOrderByRelationAggregateInputSchema';
import { DayOrderByWithRelationInputSchema } from './DayOrderByWithRelationInputSchema';
import { SuperSetOrderByRelationAggregateInputSchema } from './SuperSetOrderByRelationAggregateInputSchema';
...
export const ExerciseOrderByWithRelationInputSchema: z.ZodType<Prisma.ExerciseOrderByWithRelationInput> = z.object({
  ...
  set: z.lazy(() => SetOrderByRelationAggregateInputSchema).optional(),
  day: z.lazy(() => DayOrderByWithRelationInputSchema).optional(),
  ss: z.lazy(() => SuperSetOrderByRelationAggregateInputSchema).optional()
}).strict();

export default ExerciseOrderByWithRelationInputSchema;
