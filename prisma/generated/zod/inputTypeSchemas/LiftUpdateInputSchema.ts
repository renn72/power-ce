...
import { LiftsUpdateOneRequiredWithoutLiftNestedInputSchema } from './LiftsUpdateOneRequiredWithoutLiftNestedInputSchema';

export const LiftUpdateInputSchema: z.ZodType<Prisma.LiftUpdateInput> = z.object({
  ...
  lift: z.lazy(() => LiftsUpdateOneRequiredWithoutLiftNestedInputSchema).optional()
}).strict();

export default LiftUpdateInputSchema;
