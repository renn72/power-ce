...
import { WeekUpdateManyWithoutBlockNestedInputSchema } from './WeekUpdateManyWithoutBlockNestedInputSchema';

export const BlockUpdateInputSchema: z.ZodType<Prisma.BlockUpdateInput> = z.object({
  ...
  week: z.lazy(() => WeekUpdateManyWithoutBlockNestedInputSchema).optional()
}).strict();
