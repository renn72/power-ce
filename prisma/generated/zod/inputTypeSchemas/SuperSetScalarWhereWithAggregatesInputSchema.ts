...
export const SuperSetScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.SuperSetScalarWhereWithAggregatesInput> = z.object({
  AND: z.union([ z.lazy(() => SuperSetScalarWhereWithAggregatesInputSchema),z.lazy(() => SuperSetScalarWhereWithAggregatesInputSchema).array() ]).optional(),
  OR: z.lazy(() => SuperSetScalarWhereWithAggregatesInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => SuperSetScalarWhereWithAggregatesInputSchema),z.lazy(() => SuperSetScalarWhereWithAggregatesInputSchema).array() ]).optional(),
...
export default SuperSetScalarWhereWithAggregatesInputSchema;
