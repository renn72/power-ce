...
import { SetUncheckedCreateNestedManyWithoutExerciseInputSchema } from './SetUncheckedCreateNestedManyWithoutExerciseInputSchema';
import { SuperSetUncheckedCreateNestedManyWithoutExerciseInputSchema } from './SuperSetUncheckedCreateNestedManyWithoutExerciseInputSchema';

export const ExerciseUncheckedCreateWithoutDayInputSchema: z.ZodType<Prisma.ExerciseUncheckedCreateWithoutDayInput> = z.object({
  ...
  set: z.lazy(() => SetUncheckedCreateNestedManyWithoutExerciseInputSchema).optional(),
  ss: z.lazy(() => SuperSetUncheckedCreateNestedManyWithoutExerciseInputSchema).optional()
}).strict();

export default ExerciseUncheckedCreateWithoutDayInputSchema;
