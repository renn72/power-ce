...
import { UserProfileUpdateOneRequiredWithoutGoalsNestedInputSchema } from './UserProfileUpdateOneRequiredWithoutGoalsNestedInputSchema';
...
export const GoalUpdateInputSchema: z.ZodType<Prisma.GoalUpdateInput> = z.object({
  ...
  user: z.lazy(() => UserProfileUpdateOneRequiredWithoutGoalsNestedInputSchema).optional()
}).strict();

export default GoalUpdateInputSchema;
