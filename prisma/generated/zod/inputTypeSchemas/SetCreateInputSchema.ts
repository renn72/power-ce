...
import { ExerciseCreateNestedOneWithoutSetInputSchema } from './ExerciseCreateNestedOneWithoutSetInputSchema';

export const SetCreateInputSchema: z.ZodType<Prisma.SetCreateInput> = z.object({
  ...
  exercise: z.lazy(() => ExerciseCreateNestedOneWithoutSetInputSchema).optional()
}).strict();

export default SetCreateInputSchema;
