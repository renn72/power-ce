...
import { IngredientCreateNestedManyWithoutBaseIngredientInputSchema } from './IngredientCreateNestedManyWithoutBaseIngredientInputSchema';

export const BaseIngredientCreateInputSchema: z.ZodType<Prisma.BaseIngredientCreateInput> = z.object({
  ...
  ingredient: z.lazy(() => IngredientCreateNestedManyWithoutBaseIngredientInputSchema).optional()
}).strict();

export default BaseIngredientCreateInputSchema;
