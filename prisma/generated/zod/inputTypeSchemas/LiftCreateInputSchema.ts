...
import { LiftsCreateNestedOneWithoutLiftInputSchema } from './LiftsCreateNestedOneWithoutLiftInputSchema';

export const LiftCreateInputSchema: z.ZodType<Prisma.LiftCreateInput> = z.object({
  ...
  lift: z.lazy(() => LiftsCreateNestedOneWithoutLiftInputSchema)
}).strict();

export default LiftCreateInputSchema;
