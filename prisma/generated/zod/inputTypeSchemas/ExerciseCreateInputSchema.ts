...
import { SetCreateNestedManyWithoutExerciseInputSchema } from './SetCreateNestedManyWithoutExerciseInputSchema';
import { DayCreateNestedOneWithoutExerciseInputSchema } from './DayCreateNestedOneWithoutExerciseInputSchema';
import { SuperSetCreateNestedManyWithoutExerciseInputSchema } from './SuperSetCreateNestedManyWithoutExerciseInputSchema';
...
export const ExerciseCreateInputSchema: z.ZodType<Prisma.ExerciseCreateInput> = z.object({
  ...
  set: z.lazy(() => SetCreateNestedManyWithoutExerciseInputSchema).optional(),
  day: z.lazy(() => DayCreateNestedOneWithoutExerciseInputSchema).optional(),
  ss: z.lazy(() => SuperSetCreateNestedManyWithoutExerciseInputSchema).optional()
}).strict();

export default ExerciseCreateInputSchema;
