...
export const WeekUncheckedUpdateWithoutDayInputSchema: z.ZodType<Prisma.WeekUncheckedUpdateWithoutDayInput> = z.object({
  ...
  blockId: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
...
export default WeekUncheckedUpdateWithoutDayInputSchema;
