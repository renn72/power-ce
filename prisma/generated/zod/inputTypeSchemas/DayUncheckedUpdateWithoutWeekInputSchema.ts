...
import { ExerciseUncheckedUpdateManyWithoutDayNestedInputSchema } from './ExerciseUncheckedUpdateManyWithoutDayNestedInputSchema';

export const DayUncheckedUpdateWithoutWeekInputSchema: z.ZodType<Prisma.DayUncheckedUpdateWithoutWeekInput> = z.object({
  ...
  exercise: z.lazy(() => ExerciseUncheckedUpdateManyWithoutDayNestedInputSchema).optional()
}).strict();

export default DayUncheckedUpdateWithoutWeekInputSchema;
