...
import { IngredientUpdateManyWithoutBaseIngredientNestedInputSchema } from './IngredientUpdateManyWithoutBaseIngredientNestedInputSchema';

export const BaseIngredientUpdateInputSchema: z.ZodType<Prisma.BaseIngredientUpdateInput> = z.object({
  ...
  ingredient: z.lazy(() => IngredientUpdateManyWithoutBaseIngredientNestedInputSchema).optional()
}).strict();

export default BaseIngredientUpdateInputSchema;
