...
export const WarmupUncheckedUpdateManyInputSchema: z.ZodType<Prisma.WarmupUncheckedUpdateManyInput> = z.object({
  ...
  warmupTemplateId: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
...
export default WarmupUncheckedUpdateManyInputSchema;
