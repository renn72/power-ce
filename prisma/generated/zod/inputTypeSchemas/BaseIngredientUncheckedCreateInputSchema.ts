...
import { IngredientUncheckedCreateNestedManyWithoutBaseIngredientInputSchema } from './IngredientUncheckedCreateNestedManyWithoutBaseIngredientInputSchema';

export const BaseIngredientUncheckedCreateInputSchema: z.ZodType<Prisma.BaseIngredientUncheckedCreateInput> = z.object({
  ...
  ingredient: z.lazy(() => IngredientUncheckedCreateNestedManyWithoutBaseIngredientInputSchema).optional()
}).strict();

export default BaseIngredientUncheckedCreateInputSchema;
