...
import { UserProfileUpdateOneRequiredWithoutDailyLogNestedInputSchema } from './UserProfileUpdateOneRequiredWithoutDailyLogNestedInputSchema';
...
export const DailyLogUpdateInputSchema: z.ZodType<Prisma.DailyLogUpdateInput> = z.object({
  ...
  UserProfile: z.lazy(() => UserProfileUpdateOneRequiredWithoutDailyLogNestedInputSchema).optional()
}).strict();

export default DailyLogUpdateInputSchema;
