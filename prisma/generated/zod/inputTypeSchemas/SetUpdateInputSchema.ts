...
import { ExerciseUpdateOneWithoutSetNestedInputSchema } from './ExerciseUpdateOneWithoutSetNestedInputSchema';

export const SetUpdateInputSchema: z.ZodType<Prisma.SetUpdateInput> = z.object({
  ...
  exercise: z.lazy(() => ExerciseUpdateOneWithoutSetNestedInputSchema).optional()
}).strict();

export default SetUpdateInputSchema;
