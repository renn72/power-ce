...
import { ExerciseCreateNestedOneWithoutSsInputSchema } from './ExerciseCreateNestedOneWithoutSsInputSchema';

export const SuperSetCreateInputSchema: z.ZodType<Prisma.SuperSetCreateInput> = z.object({
  ...
  exercise: z.lazy(() => ExerciseCreateNestedOneWithoutSsInputSchema).optional()
}).strict();

export default SuperSetCreateInputSchema;
