...
const Schema: z.ZodType<Prisma.ExerciseCountOrderByAggregateInput> = z
  .object({
    ...
    isSS: z.lazy(() => SortOrderSchema).optional(),
...
export const ExerciseCountOrderByAggregateInputObjectSchema = Schema
