...
const Schema: z.ZodType<Prisma.SuperSetUncheckedCreateNestedManyWithoutExerciseInput> =
  z
    .object({
      create: z
        .union([
...
export const SuperSetUncheckedCreateNestedManyWithoutExerciseInputObjectSchema =
  Schema
