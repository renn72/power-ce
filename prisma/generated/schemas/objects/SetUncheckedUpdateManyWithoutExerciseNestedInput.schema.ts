...
const Schema: z.ZodType<Prisma.SetUncheckedUpdateManyWithoutExerciseNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(
            () => SetUpsertWithWhereUniqueWithoutExerciseInputObjectSchema,
          ),
          z
            .lazy(
              () => SetUpsertWithWhereUniqueWithoutExerciseInputObjectSchema,
      ...
      update: z
        .union([
          z.lazy(
            () => SetUpdateWithWhereUniqueWithoutExerciseInputObjectSchema,
          ),
          z
            .lazy(
              () => SetUpdateWithWhereUniqueWithoutExerciseInputObjectSchema,
...
export const SetUncheckedUpdateManyWithoutExerciseNestedInputObjectSchema =
  Schema
