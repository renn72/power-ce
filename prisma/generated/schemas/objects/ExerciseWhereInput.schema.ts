...
import { SetListRelationFilterObjectSchema } from './SetListRelationFilter.schema'
import { DayRelationFilterObjectSchema } from './DayRelationFilter.schema'
import { DayWhereInputObjectSchema } from './DayWhereInput.schema'
import { SuperSetListRelationFilterObjectSchema } from './SuperSetListRelationFilter.schema'
...
const Schema: z.ZodType<Prisma.ExerciseWhereInput> = z
  .object({
    ...
    flield5: z
      ...
      .optional()
      .nullable(),
    set: z.lazy(() => SetListRelationFilterObjectSchema).optional(),
    day: z
      .union([
        z.lazy(() => DayRelationFilterObjectSchema),
        z.lazy(() => DayWhereInputObjectSchema),
      ])
      .optional()
      .nullable(),
    ss: z.lazy(() => SuperSetListRelationFilterObjectSchema).optional(),
  })
  .strict()
