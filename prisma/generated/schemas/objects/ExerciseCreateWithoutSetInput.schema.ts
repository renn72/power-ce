...
import { SuperSetCreateNestedManyWithoutExerciseInputObjectSchema } from './SuperSetCreateNestedManyWithoutExerciseInput.schema'

import type { Prisma } from '@prisma/client'

const Schema: z.ZodType<Prisma.ExerciseCreateWithoutSetInput> = z
  .object({
    ...
    day: z
      ...
      .optional(),
    ss: z
      .lazy(() => SuperSetCreateNestedManyWithoutExerciseInputObjectSchema)
      .optional(),
  })
  .strict()

export const ExerciseCreateWithoutSetInputObjectSchema = Schema
