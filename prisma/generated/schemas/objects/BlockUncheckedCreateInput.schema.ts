import { z } from 'zod'
import { WeekUncheckedCreateNestedManyWithoutBlockInputObjectSchema } from './WeekUncheckedCreateNestedManyWithoutBlockInput.schema'

import type { Prisma } from '@prisma/client'

const Schema: z.ZodType<Prisma.BlockUncheckedCreateInput> = z
  .object({
    ...
    week: z
      .lazy(() => WeekUncheckedCreateNestedManyWithoutBlockInputObjectSchema)
      .optional(),
  })
  .strict()

export const BlockUncheckedCreateInputObjectSchema = Schema
