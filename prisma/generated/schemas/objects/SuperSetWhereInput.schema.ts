...
const Schema: z.ZodType<Prisma.SuperSetWhereInput> = z
  .object({
    AND: z
      .union([
        z.lazy(() => SuperSetWhereInputObjectSchema),
        z.lazy(() => SuperSetWhereInputObjectSchema).array(),
      ])
      .optional(),
    OR: z
      .lazy(() => SuperSetWhereInputObjectSchema)
      .array()
      .optional(),
    NOT: z
      .union([
...
export const SuperSetWhereInputObjectSchema = Schema
