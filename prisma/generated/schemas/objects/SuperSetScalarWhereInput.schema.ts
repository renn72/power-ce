...
const Schema: z.ZodType<Prisma.SuperSetScalarWhereInput> = z
  .object({
    AND: z
      .union([
      ...
      .optional(),
    OR: z
      .lazy(() => SuperSetScalarWhereInputObjectSchema)
      .array()
      .optional(),
    NOT: z
      .union([
...
export const SuperSetScalarWhereInputObjectSchema = Schema
