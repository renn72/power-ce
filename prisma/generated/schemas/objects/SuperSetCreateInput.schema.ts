import { z } from 'zod'
import { ExerciseCreateNestedOneWithoutSsInputObjectSchema } from './ExerciseCreateNestedOneWithoutSsInput.schema'

import type { Prisma } from '@prisma/client'

const Schema: z.ZodType<Prisma.SuperSetCreateInput> = z
  .object({
    ...
    exercise: z
      .lazy(() => ExerciseCreateNestedOneWithoutSsInputObjectSchema)
      .optional(),
  })
  .strict()

export const SuperSetCreateInputObjectSchema = Schema
