...
const Schema: z.ZodType<Prisma.SuperSetUncheckedCreateWithoutExerciseInput> = z
  .object({
...
export const SuperSetUncheckedCreateWithoutExerciseInputObjectSchema = Schema
