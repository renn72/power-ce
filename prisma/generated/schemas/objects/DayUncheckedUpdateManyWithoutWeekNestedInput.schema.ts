...
const Schema: z.ZodType<Prisma.DayUncheckedUpdateManyWithoutWeekNestedInput> = z
  .object({
    create: z
      .union([
...
export const DayUncheckedUpdateManyWithoutWeekNestedInputObjectSchema = Schema
