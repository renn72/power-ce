...
const Schema: z.ZodType<Prisma.WeekUpdateManyWithoutBlockNestedInput> = z
  .object({
    create: z
      .union([
        ...
        z.lazy(() => WeekUncheckedCreateWithoutBlockInputObjectSchema).array(),
      ])
      .optional(),
    connectOrCreate: z
      .union([
        z.lazy(() => WeekCreateOrConnectWithoutBlockInputObjectSchema),
        z.lazy(() => WeekCreateOrConnectWithoutBlockInputObjectSchema).array(),
      ])
      .optional(),
    upsert: z
      .union([
...
export const WeekUpdateManyWithoutBlockNestedInputObjectSchema = Schema
