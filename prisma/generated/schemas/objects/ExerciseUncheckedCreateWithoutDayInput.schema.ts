import { z } from 'zod'
import { SetUncheckedCreateNestedManyWithoutExerciseInputObjectSchema } from './SetUncheckedCreateNestedManyWithoutExerciseInput.schema'
import { SuperSetUncheckedCreateNestedManyWithoutExerciseInputObjectSchema } from './SuperSetUncheckedCreateNestedManyWithoutExerciseInput.schema'

import type { Prisma } from '@prisma/client'

const Schema: z.ZodType<Prisma.ExerciseUncheckedCreateWithoutDayInput> = z
  .object({
    ...
    set: z
      .lazy(() => SetUncheckedCreateNestedManyWithoutExerciseInputObjectSchema)
      .optional(),
    ss: z
      .lazy(
        () => SuperSetUncheckedCreateNestedManyWithoutExerciseInputObjectSchema,
      )
      .optional(),
  })
  .strict()

export const ExerciseUncheckedCreateWithoutDayInputObjectSchema = Schema
