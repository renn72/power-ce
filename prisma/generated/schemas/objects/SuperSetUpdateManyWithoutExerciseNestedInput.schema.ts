...
const Schema: z.ZodType<Prisma.SuperSetUpdateManyWithoutExerciseNestedInput> = z
  .object({
    create: z
      .union([
...
export const SuperSetUpdateManyWithoutExerciseNestedInputObjectSchema = Schema
