...
const Schema: z.ZodType<Prisma.ExerciseUpdateManyWithoutDayNestedInput> = z
  .object({
    create: z
      .union([
    ...
    upsert: z
      .union([
        z.lazy(() => ExerciseUpsertWithWhereUniqueWithoutDayInputObjectSchema),
        z
          .lazy(() => ExerciseUpsertWithWhereUniqueWithoutDayInputObjectSchema)
          .array(),
      ])
      .optional(),
    createMany: z
    ...
    update: z
      .union([
        z.lazy(() => ExerciseUpdateWithWhereUniqueWithoutDayInputObjectSchema),
        z
          .lazy(() => ExerciseUpdateWithWhereUniqueWithoutDayInputObjectSchema)
          .array(),
      ])
      .optional(),
    updateMany: z
...
export const ExerciseUpdateManyWithoutDayNestedInputObjectSchema = Schema
