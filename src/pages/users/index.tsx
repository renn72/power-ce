    ...
    <>
      {isSidebarOpen ? (
        <Tab
          className={({ selected }) =>
            classNames(
              'py-2 tracking-tighter hover:bg-gray-900 md:py-4',
              selected
...
const Users = () => {
  ...
  const isRoot = user?.isPowerTrainer
  ...
  return (
    <>
      <LoadingWrapper
        ...
        setIsOpen={setIsOpen}
      />
      <main className=' px-2-3 relative flex h-full min-w-[1500px] flex-col items-center justify-center gap-8 sm:px-2'>
        <Tab.Group
          vertical
          defaultIndex={0}
          onChange={(index) => {
        ...
        >
          <div className='flex w-full gap-4 lg:gap-6'>
            <Tab.List
              className={cn(
                'mt-4 flex flex-col divide-y divide-yellow-500',
            ...
            >
              <div>
                {isSidebarOpen ? (
                  <ChevronLeftCircle
                    strokeWidth={1}
                    className='mx-auto mb-4 h-8 w-8 cursor-pointer text-yellow-500 hover:text-yellow-300'
                    onClick={() => {
              ...
              <Tab.Panel className='mt-4'>
                <div className='mt-4 flex flex-col gap-4'>
                  ...
                  <TemplateSelect
                    ...
                    isCurrent={false}
                  />
                  { isRoot ? <TrainerSelect userId={userId} /> : null }
                </div>
              </Tab.Panel>
