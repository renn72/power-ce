...
const TrainerSelect = ({ userId }: { userId: string }) => {
  ...
  return (
    <div className='mx-2 flex flex-row gap-6 justify-normal'>
      <div className='flex w-64 items-end justify-between gap-2 text-lg font-semibold'>
      ...
      <div className='flex justify-start gap-2 items-center'>
        <div className='flex flex-col justify-center font-bold text-base'>
          ...
          >
            <div className='z-1 relative'>
              <Listbox.Button className='relative h-10 w-60 md:w-60 cursor-default border-b border-gray-600 pl-3 pr-10 text-left shadow-md hover:border-white focus:outline-none '>
        ...
        <div className='ml-4 flex items-end justify-start gap-2'>
          <PencilSquareIcon
            className='w-8 h-8 md:w-8 text-gray-400 hover:text-green-600'
            onClick={() => onSetTraienrWrapper()}
          />
          <XCircleIcon
            className='col-span-1 w-8 h-8 md:w-8 text-gray-400 hover:text-red-600'
