...
const TemplateSelect = ({
    ...
    const { data: blocksTitle, isLoading } =
        api.templateBuilder.getAllTemplateTitlesSuper.useQuery({
            userId: userId,
            ...
            >
                <div className='z-110 relative'>
                    <Listbox.Button className='relative h-12 max-h-min w-full cursor-default border-b border-gray-600 py-2 pl-3 pr-10 text-left shadow-md hover:border-gray-200 focus:outline-none '>
                        ...
                        >
                            {blocksTitle?.find((b) => b.id === selectedTemplate)
                    ...
                    <Transition
                        ...
                        leaveTo='opacity-0'
                    >
                        <Listbox.Options className='absolute z-20 mt-1 max-h-96 w-full overflow-auto border border-gray-600 bg-black py-1 '>
